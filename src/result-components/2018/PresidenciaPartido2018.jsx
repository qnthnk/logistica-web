...
import './PresidenciaPartido2018.css'; // Importamos el CSS de estilos
// Importamos el JSON localmente
import localData from '../jsons/presidenciapartido2018.json';

const PresidenciaPartido2018 = () => {
              ...
              <tbody>
                {sortedData.map((item, index) => (
                  <tr key={index} className="border-dark border-1 table-stripped">
                    <th scope="row">
                      <img
                        alt={item.siglasPartido}
                        style={{ height: "50px", width: "auto" }}
                        className="imagen-candidato-movil"
                        src={`https://computos2018.ine.mx/assets/img/LogosPartidos/${item.emblemaPartido}`}
...
export default PresidenciaPartido2018;
